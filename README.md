...
A to-do list app built using React which features local storage to allow users' lists to persist after closing. The app allows for
...
View the live demo [here.](https://get-it-done-today.netlify.app/)
